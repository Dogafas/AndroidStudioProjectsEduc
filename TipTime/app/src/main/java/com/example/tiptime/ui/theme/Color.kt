...
val md_theme_light_tertiary = Color(0xFF984060) // Сохранено близкое к оригиналу
...
val md_theme_light_background = Color(0xFFF8FDFC)
val md_theme_light_onBackground = Color(0xFF1A1C1E)
val md_theme_light_surface = Color(0xFFF8FDFC)
...
val md_theme_light_inverseOnSurface = Color(0xFFEFF0F7)
...
val md_theme_dark_secondary = Color(0xFFE0C447)
val md_theme_dark_onSecondary = Color(0xFF3B3000)
val md_theme_dark_secondaryContainer = Color(0xFF544600)
val md_theme_dark_onSecondaryContainer = Color(0xFFFFE081)
val md_theme_dark_tertiary = Color(0xFFFFB1C7) // Сохранено близкое к оригиналу
